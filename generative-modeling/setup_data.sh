...
pip show clean-fid
mkdir /opt/conda/lib/python3.7/site-packages/cleanfid/stats
cp cub_clean_custom_na.npz /opt/conda/lib/python3.7/site-packages/cleanfid/stats/cub_clean_custom_na.npz
